...
public class HongBaoUtil {
	    public static final String MCH_ID = "1490776702";                   //商户号  
	    public static final String WXAPPID = "wx37a5a7281317047a";             //公众账号appid  
	    ...
	    public static final String CLIENT_IP = "120.24.43.56";            //调用接口的机器IP  
	    public static final String ACT_NAME = "****";                  //活动名称  
	    public static final String REMARK = "****";                    //备注  
	    public static final String KEY = "123456789101112131415139399300Sz"; //秘钥  
