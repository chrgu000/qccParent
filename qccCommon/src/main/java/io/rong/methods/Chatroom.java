...
public class Chatroom {
	...
	public CodeSuccessResult create(ChatRoomInfo[] chatRoomInfo) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/create.json", "application/x-www-form-urlencoded");
	...
	public CodeSuccessResult join(String[] userId, String chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/join.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public ChatroomQueryResult query(String[] chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/query.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessResult stopDistributionMessage(String chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/message/stopDistribution.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessResult resumeDistributionMessage(String chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/message/resumeDistribution.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessResult addGagUser(String userId, String chatroomId, String minute) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/user/gag/add.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public ListGagChatroomUserResult ListGagUser(String chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/user/gag/list.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);

		return (ListGagChatroomUserResult) GsonUtil.fromJson(HttpUtil.returnResult(conn),
				ListGagChatroomUserResult.class);
	}
	...
	public CodeSuccessResult rollbackGagUser(String userId, String chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/user/gag/rollback.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public ListBlockChatroomUserResult getListBlockUser(String chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/user/block/list.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);

		return (ListBlockChatroomUserResult) GsonUtil.fromJson(HttpUtil.returnResult(conn),
				ListBlockChatroomUserResult.class);
	}
	...
	public CodeSuccessResult rollbackBlockUser(String userId, String chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/user/block/rollback.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	 ...
	 * 添加聊天室消息优先级方法
	 * 
	 * @param objectName:低优先级的消息类型，每次最多提交
	...
	public CodeSuccessResult destroy(String[] chatroomId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/destroy.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessResult addWhiteListUser(String chatroomId, String[] userId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/chatroom/user/whitelist/add.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
