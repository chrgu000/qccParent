...
public class Message {
	 ...
	 **/
	public CodeSuccessResult publishPrivate(String fromUserId, String[] toUserId, BaseMessage message,
	...
	public CodeSuccessResult publishTemplate(TemplateMessage templateMessage) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/message/private/publish_template.json", "application/json");
	 ...
	 * @return CodeSuccessResult
	 **/
	public CodeSuccessResult PublishSystem(String fromUserId, String[] toUserId, BaseMessage message,
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/message/system/publish.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessResult publishSystemTemplate(TemplateMessage templateMessage) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/message/system/publish_template.json", "application/json");
		HttpUtil.setBodyParameter(templateMessage.toString(), conn);
	 ...
	 * @return CodeSuccessResult
	 **/
	public CodeSuccessResult publishGroup(String fromUserId, String[] toGroupId, BaseMessage message,
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/message/group/publish.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	 ...
	 * @return CodeSuccessResult
	 **/
	public CodeSuccessResult publishDiscussion(String fromUserId, String toDiscussionId, BaseMessage message,
			String pushContent, String pushData, Integer isPersisted, Integer isCounted, Integer isIncludeSender)
			throws Exception {
		if (fromUserId == null) {
			throw new IllegalArgumentException("Paramer 'fromUserId' is required");
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/message/discussion/publish.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	 ...
	 * @return CodeSuccessResult
	 **/
	public CodeSuccessResult publishChatroom(String fromUserId, String[] toChatroomId, BaseMessage message)
			throws Exception {
		if (fromUserId == null) {
			throw new IllegalArgumentException("Paramer 'fromUserId' is required");
		}
	 ...
	 * @return CodeSuccessResult
	 **/
	public CodeSuccessResult broadcast(String fromUserId, BaseMessage message, String pushContent, String pushData,
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/message/broadcast.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public HistoryMessageResult getHistory(String date) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/message/history.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessResult deleteMessage(String date) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret,
				"/message/history/delete.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
