...
public class User {
	...
	public CodeSuccessResult block(String userId, Integer minute) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/user/block.json",
	...
	public QueryBlacklistUserResult queryBlacklist(String userId) throws Exception {
		...
		return (QueryBlacklistUserResult) GsonUtil.fromJson(HttpUtil.returnResult(conn),
				QueryBlacklistUserResult.class);
	}
