...
public class PushMessage {
	...
	MsgObj message;
	// 按操作系统类型推送消息内容，如 platform 中设置了给 ios 和 android 系统推送消息，而在 notification 中只设置了
	// ios 的推送内容，则 android 的推送内容为最初 alert 设置的内容。
	Notification notification;

	public PushMessage(String[] platform, String fromuserid, TagObj audience, MsgObj message,
			Notification notification) {
