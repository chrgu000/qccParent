...
public class ExcelExportSXXSSF {
	...
	public String exportFile() throws Exception {
		String filename = filePrefix+"_"+IDUtils.genItemId() + ".xlsx";
	...
	public static void main(String[] args) throws Exception {
		...
		fieldCodes.add("telephone");//药品流水号
		...
		User user1= new User();user1.setTelephone(111L);
		User user2= new User();user1.setTelephone(111L);
		list.add(user1);
		list.add(user2);
