...
public class WX_TemplateMsgUtil {
    ...
    public static String getWXTemplateMsgId(String templateSerialNumber){
    	String token = MD5Util.getAccessToken(PayCommonConfig.qcc_gzhappid, PayCommonConfig.qcc_gzhsecret);// 获取AccessToken
    ...
    public static String sendWechatMsgToUser(String touser, String templatId, String clickurl, String topcolor, JSONObject data) {
    	...
    	//String ACCESS_TOKEN = IDUtils.getxiaoAccessToken(PayCommonConfig.qcc_xiaochengxuappid, PayCommonConfig.qcc_xiaochengxuSecret);
