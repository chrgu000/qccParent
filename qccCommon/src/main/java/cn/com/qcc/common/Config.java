...
public class Config {
	...
	public static final String commomURL = "common";
	...
	public static final String resultmess = "resultmess";
	
	/**
	 * 配置文件中系统基础url的key名称
	 */
	public static final String Accestoken_url = "AccessTokenInterUrl";
